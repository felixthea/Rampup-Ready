class InvitesController < ApplicationController
	...
	def new
		@invite_url = "http://mediamath.rampupready.com/invite/rsvp?signup=" + current_co.signup_token + "&inviter=" + current_user.name.split(" ")[0]
	...
	def create
		...
		invitees.each do |invitee|
			...
			invite_link = "http://mediamath.rampupready.com/invite/rsvp?signup=" + current_co.signup_token + "&name=" + full_name + "&inviter=" + inviter + "&email=" + email
	...
	def new_employees
		...
		@generic_invite_link = "http://mediamath.rampupready.com/signup?signup=" + current_co.signup_token
	...
	def create_employees
		...
		invite_link = "http://mediamath.rampupready.com/signup?signup=" + current_co.signup_token + "&name=" + name + "&email=" + email
